...
test({
  arb:
    // "Hello undefined!"
    ttfc.constant('Hello undefined!'),
})
test({
  arb:
    // "Hello null!"
    ttfc.constant('Hello null!'),
})
test({
  arb:
    // "Hello false!" | "Hello true!"
    ttfc.constantFrom('Hello false!', 'Hello true!'),
})
test({
  arb:
    // "Hello false!"
    ttfc.constant('Hello false!'),
})
test({
  arb:
    // "Hello true!"
    ttfc.constant('Hello true!'),
})
test({
  arb:
    // "Hello true!"
...
test({
  arb:
    // "Hello 42!"
    ttfc.constant('Hello 42!'),
})
test({
  arb:
    // `Hello ${bigint}!`
    ttfc.bigInt().map(value => `Hello ${value}!`),
})
test({
  arb:
    // "Hello 42!"
...
test({
  arb:
    // `Hello ${string}!`
    ttfc.string().map(value => `Hello ${value}!`),
})
test({
  arb:
...
test({
  arb:
    // Capitalize<string>
    ttfc.string().map(value => value.charAt(0).toUpperCase() + value.slice(1)),
})
test({
  arb:
    // "hi"
...
test({
  arb:
    // Uncapitalize<string>
    ttfc.string().map(value => value.charAt(0).toLowerCase() + value.slice(1)),
})
// Symbol
test({
  arb:
...
test({
  arb:
    ...
    ttfc.oneof(
      ttfc.tuple(ttfc.string()),
      ttfc.tuple(ttfc.string(), ttfc.option(ttfc.double(), { nil: undefined })),
      ttfc.tuple(
        ttfc.string(),
...
test({
  arb:
    // [string, ...number[], boolean]
    ttfc
      .tuple(ttfc.string(), ttfc.array(ttfc.double()), ttfc.boolean())
      .map(value => [value[0], ...value[1], value[2]]),
})
test({
  arb:
    // [...string[], number, boolean]
    ttfc
      .tuple(ttfc.array(ttfc.string()), ttfc.double(), ttfc.boolean())
      .map(value => [...value[0], value[1], value[2]]),
})
test({
  arb:
...
test({
  arb:
    // { a: string; b: number; }
    ttfc.record({ a: ttfc.string(), b: ttfc.double() }),
})
test({
  arb:
...
test({
  arb:
    // { a: string; b?: number | undefined; }
    ttfc.record(
      { a: ttfc.string(), b: ttfc.option(ttfc.double(), { nil: undefined }) },
      { requiredKeys: ['a'] },
    ),
})
test({
...
test({
  arb:
    // Required<{ a: string; b?: number | undefined; }>
    ttfc.record({ a: ttfc.string(), b: ttfc.double() }),
})
test({
  arb:
...
test({
  arb:
    // Pick<{ a: string; b?: number | undefined; c: boolean; }, "a">
    ttfc.record({ a: ttfc.string() }),
})
test({
  arb:
    // Pick<{ a: string; b?: number | undefined; c: boolean; }, "a" | "c">
    ttfc.record({ a: ttfc.string(), c: ttfc.boolean() }),
})
test({
  arb:
    // Omit<{ a: string; b?: number | undefined; c: boolean; }, "a">
    ttfc.record(
      { b: ttfc.option(ttfc.double(), { nil: undefined }), c: ttfc.boolean() },
      { requiredKeys: ['c'] },
    ),
})
test({
...
test({
  arb:
    ...
    ttfc.record({ c: ttfc.string(), a: ttfc.string(), b: ttfc.double() }),
})
...
test({
  arb:
    // InterfaceWithFunctions
    ttfc.record({
      a: ttfc.func(ttfc.double()),
      b: ttfc.func(ttfc.string()),
      c: ttfc.func(ttfc.boolean()),
    }),
})
// Class
class _C {
...
test({
  arb:
    // { [key: string]: number; a: number; }
    ttfc
      .tuple(
        ttfc.dictionary(ttfc.string(), ttfc.double()),
        ttfc.record({ a: ttfc.double() }),
      )
      .map(value => globalThis.Object.assign(...value)),
})
test({
  arb:
    // { [key: string]: string | number; a: string; }
    ttfc
      .tuple(
        ttfc.dictionary(
          ttfc.string(),
...
test({
  arb:
    ...
    ttfc
      .tuple(
        ttfc.dictionary(ttfc.string(), ttfc.boolean()),
        ttfc.dictionary(
...
test({
  arb:
    // () => string
    ttfc.func(ttfc.string()),
})
test({
  arb:
    // Function
    ttfc.func(ttfc.anything()),
  typecheck: false,
})
test({
  arb:
...
test({
  arb:
    // { (): string; a: string; }
    ttfc
      .tuple(ttfc.func(ttfc.string()), ttfc.record({ a: ttfc.string() }))
      .map(value => globalThis.Object.assign(...value)),
  typecheck: false,
})
test({
...
test({
  arb:
    ...
    ttfc
      .tuple(
        ttfc.func(ttfc.string()),
        ttfc.record({ a: ttfc.string(), b: ttfc.func(ttfc.double()) }),
      )
      .map(value => globalThis.Object.assign(...value)),
  typecheck: false,
})
...
test({
  arb:
    // PartiallyImplicitIntEnum
    ttfc.constantFrom(2, 3, 4, 5),
})
test({
  arb:
    // PartiallyImplicitIntEnum.B
    ttfc.constant(5),
})
// Union
test({
...
test({
  arb:
    // 1 | 3 | 2 | 4
    ttfc.constantFrom(1, 2, 3, 4),
})
test({
  arb:
    // 1n | 3n | 2n | 4n
    ttfc.constantFrom(1n, 2n, 3n, 4n),
})
test({
  arb:
    // "a" | "b" | "c" | "d"
    ttfc.constantFrom('a', 'b', 'c', 'd'),
})
test({
  arb:
...
test({
  arb:
    // { type: "a"; a: string; }
    ttfc.record({ type: ttfc.constant('a'), a: ttfc.string() }),
})
test({
  arb:
    // string
...
test({
  arb:
    // { type: "b"; b: string; }
    ttfc.record({ type: ttfc.constant('b'), b: ttfc.string() }),
})
test({
  arb:
    // string
...
test({
  arb:
    ...
    ttfc.record(
      { a: ttfc.string(), b: ttfc.option(ttfc.string(), { nil: undefined }) },
      { requiredKeys: ['a'] },
    ),
})
test({
  arb:
    // { readonly a: boolean; b?: boolean | undefined; }
    ttfc.record(
      { a: ttfc.boolean(), b: ttfc.option(ttfc.boolean(), { nil: undefined }) },
      { requiredKeys: ['a'] },
    ),
})
test({
...
test({
  arb:
    ...
    ttfc.record({ a: ttfc.string(), b: ttfc.string() }),
})
test({
  arb:
    // { readonly a?: string | undefined; b?: string | undefined; }
    ttfc.record({
      a: ttfc.option(ttfc.string(), { nil: undefined }),
      b: ttfc.option(ttfc.string(), { nil: undefined }),
    }),
})
test({
  arb:
    // { readonly aa: string; bb?: string | undefined; }
    ttfc.record(
      { aa: ttfc.string(), bb: ttfc.option(ttfc.string(), { nil: undefined }) },
      { requiredKeys: ['aa'] },
    ),
})
// Recursion
  ...
  arb:
    ...
    ttfc.letrec(tie => ({
      arb0: ttfc.record(
        {
          value: ttfc.double(),
          next: ttfc.option(tie('arb0'), { nil: undefined }),
        },
        { requiredKeys: ['value'] },
      ),
    })).arb0,
...
test({
  arb:
    ...
    ttfc.letrec(tie => ({
      arb0: ttfc.record(
        { value: ttfc.double(), next: tie('arb1') },
        { requiredKeys: ['value'] },
      ),
      arb1: ttfc.option(
        ttfc.oneof(
          tie('arb0'),
          ttfc.record(
            { value: ttfc.string(), next: tie('arb1') },
            { requiredKeys: ['value'] },
          ),
        ),
        { nil: undefined },
  ...
  arb:
    ...
    ttfc.letrec(tie => ({
      arb0: ttfc.option(
        ttfc.oneof(
          ttfc.record(
            { value: ttfc.double(), next: tie('arb0') },
            { requiredKeys: ['value'] },
          ),
          ttfc.record(
            { value: ttfc.string(), next: tie('arb0') },
            { requiredKeys: ['value'] },
          ),
        ),
        { nil: undefined },
      ...
      arb1: ttfc.record(
        {
          value: ttfc.double(),
          next: ttfc.option(tie('arb1'), { nil: undefined }),
        },
        { requiredKeys: ['value'] },
      ),
      arb: ttfc.record(
        { value: ttfc.double(), next: tie('arb0'), node: tie('arb1') },
        { requiredKeys: ['value', 'node'] },
      ),
    })).arb,
})
// Type parameter
